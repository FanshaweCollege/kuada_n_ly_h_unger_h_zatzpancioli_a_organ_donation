...
<section class="videoBox large-12 medium-12 small-12 columns" id="videoBox"> 
  <div class="videoYouCan large-offset-1 large-10 large-offset-1 medium-offset-1 medium-10 medium-offset-1 small-12 columns">
    ...
    <div class="youCan large-offset-1 large-5 medium-offset-1 medium-5 small-12 columns">
        <div id="youCanBox">
  ...
  <div class="beat large-12 medium-12 small-push-12 align-center columns">
      <object data="images/heart_beat.svg" id="beat"></object>
  </div>
</section>
...
<section class="donationBox large-12 medium-12 small-12 columns" id="donationBox">
  <div class="donation large-offset-1 large-10 large-offset-1 medium-12 small-12 columns">
    ...
    <div class="large-4 medium-4 small-12 columns">
      ...
      <p>Kidney, corneas, heart, lungsl, liver, pancreas, small bowel and tissue.<br>You are able to donate some organs while you’re alive, for example, a kidney, or part of your liver but most organ and tissue donations will come from people who have died.
      </p>
    </div>
    <div class="large-4 medium-4 small-12 columns">
    ...
    <div class="large-4 medium-4 small-12 columns">
      ...
      <p>To be an organ donor you need to die in hospital in specific circumstances. When this happens, a specialist nurse will check if you’re a registered organ donor.<br> If you are a registered donor, your family will be expected to support your decision, and if you aren’t, they will be asked to make a decision on your behalf.</p>
    </div>
  </div>
...
<section class="aboutBox large-12 medium-12 small-12 columns" id="aboutBox"> 
  ...
  <div class="iconBox large-4 large-4 medium-4 small-12 align-center columns">
    <img src="images/mission_icon.svg" class="icon">
    <h2>Our Mission</h2>
    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
  </div>
  <div class="iconBox large-4 medium-4 small-12 align-center columns">
